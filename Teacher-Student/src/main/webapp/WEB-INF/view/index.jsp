...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 你问我答<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/total/answer" data-title="你问我答" href="javascript:void(0)">你问我答</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${pageContext.request.contextPath}/welcome.jsp">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath}/lib-css/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
