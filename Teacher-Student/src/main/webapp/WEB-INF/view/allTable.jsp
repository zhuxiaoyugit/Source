				...
				<div class="row">
	                  ...
	                  <div class="col-md-12">
	                  	  <div class="content-panel">
	                  	  	  <h4><i class="fa fa-angle-right"></i> 老师表</h4>
	                  	  	  <hr>
		                      <table class="table">
		                          <thead>
		                          <tr>
		                          ...
		                          <c:forEach items="${teacherList}" var="teacher" varStatus="teacherStatus">
			                          <tr>
			                              <td> <label for="uid${teacherStatus.index}"><span class="font12_blue">${teacher.id }</span></label></td>
			                              <td> <label for="uid${teacherStatus.index}"><span class="font12_blue">${teacher.teacherName }</span></label></td>
			                              <td> <label for="uid${teacherStatus.index}"><span class="font12_blue">${teacher.teacherJob }</span></label></td>
			                          </tr>
		                          </c:forEach>  
		                          </tbody>
		                      </table>
	                  ...
	                  <div class="col-md-12 mt">
	                  	<div class="content-panel">
	                          <table class="table table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> 学生表</h4>
	                  	  	  <hr>
	                              <thead>
	                              <tr>
	                                  <th>#</th>
	                             ...
	                             <c:forEach items="${studentList}" var="student" varStatus="studentStatus">
			                          <tr>
			                              <td> <label for="uid${studentStatus.index}"><span class="font12_blue">${student.id }</span></label></td>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> 作业详情</h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
